...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <h5 class="card-title mb-0">Tambah Jenis Obat</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('jenis_obats.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_jenis" class="form-control @error('deskripsi_jenis') is-invalid @enderror"
                                rows="4">{{ old('deskripsi_jenis') }}</textarea>
